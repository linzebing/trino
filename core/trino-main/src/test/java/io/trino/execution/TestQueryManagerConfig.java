...
public class TestQueryManagerConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(QueryManagerConfig.class)
                ...
                .setFaultTolerantExecutionRuntimeAdaptivePartitioningMaxTaskSize(DataSize.of(24, GIGABYTE))
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("fault-tolerant-execution-runtime-adaptive-partitioning-max-task-size", "20GB")
        ...
        QueryManagerConfig expected = new QueryManagerConfig()
                ...
                .setFaultTolerantExecutionRuntimeAdaptivePartitioningMaxTaskSize(DataSize.of(20, GIGABYTE))
